...
class ArticleListCreateView(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        logging.info(f"article {serializer.data.get('title')} created by {self.request.user.first_name}")

    
class ArticleRetriveUpdateDistroyView(generics.RetrieveUpdateDestroyAPIView):
    queryset=Article.objects.all()
    serializer_class=ArticleSerializer
...
class ClapArticleView(generics.CreateAPIView , generics.DestroyAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "details" : "Clap removed from article.",
            },
